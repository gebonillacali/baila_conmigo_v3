...
public class ReproductorAvatar : MonoBehaviour
{	
	...
	public void setPathFile(string pathFile) {
		...
		((ReproductorArchivoLector)sw).setInputFile(pathFile);
		playing = true;
	}
...
//		}
	...
	protected void MoveAvatar()
	{
		...
		Vector3 trans = kinectManager.getSkeletonPos (sw.getSkeleton ());
