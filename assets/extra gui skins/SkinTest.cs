...
public class SkinTest : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        rctWindow4 = new Rect(320, 20, 320, 400);
        for (int i = 0; i < 19; i++)
        {
    ...
    void OnGUI()
    {
       ...
       // rctWindow1 = GUI.Window(0, rctWindow1, DoMyWindow, "Orange Unity", GUI.skin.GetStyle("window"));
        ...
        rctWindow2 = GUI.Window(1, rctWindow2, DoMyWindow2, "Baila Conmigo", GUI.skin.GetStyle("window"));
    ...
    {
        GUILayout.Label("Registre el Jugador");
        GUILayout.BeginVertical();
        /*GUILayout.BeginHorizontal();
